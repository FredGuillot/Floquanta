(() => {
  ...
  const translations = {
    ...
    fr: {
      meta: { title: 'Floquanta — Explorez ce qui est possible', description: "Modèles quantitatifs et simulation pour les décisions en contexte d'incertitude." },
      ...
      apps: { title: "Des questions qui méritent d'être modélisées.", copy: "Floquanta peut partir d'une question financière et élargir le modèle seulement jusqu'au niveau requis par la décision.", q1: 'Que se passe-t-il si notre plus important client nous quitte?', q2: 'Que se passe-t-il si les coûts augmentent plus rapidement que les revenus?', q3: 'À quelle vitesse pouvons-nous croître sans mettre notre liquidité sous pression?', q4: 'À quel point notre liquidité résiste-t-elle à un scénario de stress?', q5: 'Quelles incertitudes influencent réellement nos résultats?', types: 'Financier <i>·</i> Opérationnel <i>·</i> Risque <i>·</i> Stratégique' },
      personal: { title: "La même philosophie,<br>à l'échelle personnelle.", copy: "Floquanta Personal est une application gratuite destinée au grand public qui illustre l'approche Floquanta : partir d'un plan, explorer des scénarios et comprendre différents futurs financiers possibles.", copy2: "Elle aide les gens à explorer des futurs possibles plutôt qu'à prétendre les prédire.", soon: 'Bientôt disponible', note: 'Une application grand public distincte qui partage la même philosophie de modélisation.', imageAlt: "Écran de prévision de Floquanta Personal montrant l'évolution du solde dans le temps" },
      about: { label: 'À propos de Floquanta', title: 'Rigueur mathématique.<br>Décisions concrètes.', copy: "Floquanta combine la modélisation mathématique, la pensée actuarielle, la simulation, l'analytique et les technologies modernes afin d'aider les organisations à mieux comprendre les systèmes complexes et les futurs incertains." },
