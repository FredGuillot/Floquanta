(() => {
  ...
  const translations = {
    en: {
      ...
      nav: { menu: 'Menu', approach: 'Approach', capabilities: 'Capabilities', applications: 'Applications', forYou: 'For You', about: 'About', talk: "Let's Talk" },
      ...
      apps: { title: 'Questions worth modeling.', copy: 'Floquanta starts with a financial question and develops a model at the right level for the decision.', q1: 'What if our largest customer leaves?', q2: 'What if costs rise faster than revenue?', q3: 'How fast can we grow without putting liquidity under pressure?', q4: 'How resilient is our liquidity under stress?', q5: 'Which uncertainties actually drive our outcome?', types: 'Financial <i>·</i> Operational <i>·</i> Risk <i>·</i> Strategic' },
      personal: { label: 'Floquanta For You', title: 'The same philosophy, for your personal finances.', copy: 'Experience the Floquanta approach applied to your personal finances.', copy2: 'The Floquanta app lets you start from your financial situation, explore different scenarios and better understand possible financial futures.', soon: 'Coming soon', note: 'Free. A simple way to experience Floquanta through your own finances.', imageAlt: 'Floquanta app forecast screen showing a balance trajectory over time' },
    ...
    fr: {
      meta: { title: 'Floquanta — Explorer les possibilités', description: "Modèles quantitatifs et simulations pour de meilleures décisions en présence d'incertitude." },
      ...
      nav: { menu: 'Menu', approach: 'Approche', capabilities: 'Capacités', applications: 'Applications', forYou: 'Pour vous', about: 'À propos', talk: 'Discutons-en' },
      hero: { label: 'Intelligence décisionnelle', title: 'Explorer les possibilités', subhead: "Modèles quantitatifs et simulations pour de meilleures décisions en présence d'incertitude.", intro: "Floquanta construit des représentations mathématiques simplifiées de systèmes d'affaires complexes afin d'explorer les futurs possibles et comprendre les conséquences des décisions.", cta: 'Découvrir Floquanta', manifesto: 'Nous ne modélisons pas tout.<br><strong>Nous modélisons ce qui compte.</strong>' },
      diagram: { decision: 'Décision', uncertainty: 'Incertitude', futures: 'Futurs possibles' },
      approach: { label: 'Notre approche', title: 'Systèmes complexes.<br><em>Modèles simplifiés.</em>', copy: "Un modèle utile n'a pas besoin de reproduire une organisation entière. Il doit représenter les variables, les relations et les incertitudes qui comptent pour la décision.", complexSystem: 'Système complexe', relevantModel: 'Modèle pertinent', frame: 'Définir', frameCopy: 'Commencer par la décision, pas par le modèle.', simplify: 'Simplifier', simplifyCopy: 'Identifier la plus simple représentation utile.', simulate: 'Simuler', simulateCopy: "Propager l'incertitude à travers des milliers de futurs possibles.", explore: 'Explorer', exploreCopy: 'Comparer les scénarios et comprendre leurs conséquences.', refine: 'Affiner', refineCopy: 'Améliorer le modèle de façon itérative à mesure que de nouvelles informations émergent.', closing: 'Ne modéliser que ce qui compte pour la décision.' },
      twins: { label: 'Jumeaux décisionnels', title: 'Une représentation quantitative légère<br>de votre organisation.', copy: "Intégrer les variables financières et opérationnelles, ainsi que le contexte et l'incertitude dans un modèle parcimonieux conçu autour d'une question d'affaires précise.", business: 'Organisation', businessItems: 'Revenus · Coûts · Opérations', model: 'Modèle', modelItems: 'Relations · Incertitude', futures: 'Futurs', futureItems: 'Simulation · Scénarios', base: 'Scénario de base', baseCopy: 'Évolution attendue', stress: 'Stress', stressCopy: 'Départ du plus important client', decision: 'Décision', decisionCopy: "Investir 2 M$ aujourd'hui", note: 'Pas un jumeau numérique massif.', noteCopy: 'Un modèle ciblé conçu pour répondre aux questions qui comptent vraiment.' },
      ...
      apps: { title: "Des questions qui méritent d'être modélisées.", copy: "Floquanta part d'une question financière et élabore un modèle au juste niveau requis par la décision.", q1: 'Que se passe-t-il si notre plus important client nous quitte?', q2: 'Que se passe-t-il si les coûts augmentent plus rapidement que les revenus?', q3: 'À quelle vitesse pouvons-nous croître sans mettre notre liquidité sous pression?', q4: 'À quel point notre liquidité résiste-t-elle à un scénario de stress?', q5: 'Quelles incertitudes influencent réellement nos résultats?', types: 'Financier <i>·</i> Opérationnel <i>·</i> Risque <i>·</i> Stratégique' },
      personal: { label: 'Floquanta Pour vous', title: 'La même philosophie pour vos finances personnelles.', copy: "Découvrez l'approche Floquanta appliquée à vos finances personnelles.", copy2: "L'application Floquanta vous permet de partir de votre situation financière, d'explorer différents scénarios et de mieux comprendre les futurs financiers possibles.", soon: 'Bientôt disponible', note: "Gratuite. Une façon simple de vivre l'expérience Floquanta à travers vos propres finances.", imageAlt: "Écran de prévision de l'application Floquanta montrant l'évolution du solde dans le temps" },
